...
%   \node[anchor=north east, xshift=-1cm, yshift=-1.6cm, draw=black!40, line width=0.4pt, inner sep=0pt] at (current page.north east) {\includegraphics[width=2.3cm]{Photo/dpn_photo.jpg}};
% \end{tikzpicture}
